...
(
    ...
    LAST_RECEIVED_MESSAGE INT NOT NULL DEFAULT 0,
...
ALTER TABLE USERS 
	ADD COLUMN LAST_RECEIVED_MESSAGE_GROUP INT NOT NULL DEFAULT 0;

ALTER TABLE USERS
  CHANGE COLUMN LAST_RECEIVED_MESSAGE LAST_RECEIVED_MESSAGE_INDIVIDUAL
