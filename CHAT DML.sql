...
WHERE USERS.ID_USER = SEND_INDIVIDUAL_MESSAGE.ID_USER_RECEIVER AND
	...
	MESSAGES.ID_MESSAGE > USERS.LAST_RECIEVED_MESSAGE_INDIVIDUAL
...
WHERE USERS.ID_USER = BELONG.ID_USER AND BELONG.ID_GROUP = SEND_MESSAGE_GROUP.ID_GROUP
    ...
    USERS.ID_USER = ###MI ID### AND
	MESSAGES.ID_MESSAGE > USERS.LAST_RECIEVED_MESSAGE_GROUP
	AND MESSAGES.ID_MESSAGE <= ### G ### ;
	
--------------------- PARTE 3. -------------
UPDATE USERS
	SET USERS.LAST_RECIEVED_MESSAGE_INDIVIDUAL = ### I ### , 
		USERS.LAST_RECIEVED_MESSAGE_GROUP = ### G ###
